...
class ConnectView(BaseConnectView):
    class Form(BaseConnectView.Form):
        account_sid = forms.CharField(label=_("Account SID"), help_text=_("ACCOUNT SID of a twilio account organization."))
        auth_token = forms.CharField(label=_("Auth Token"), help_text=_("Auth token of a twilio account organization."))
        chat_service_sid = forms.CharField(label=_("Chat Service SID"), help_text=_("SID of a Chat service."))
        flex_flow_sid = forms.CharField(label=_("Flex Flow"), help_text=_("SID of a Flex Flow (also called Flex Address) that is of the task type."))
